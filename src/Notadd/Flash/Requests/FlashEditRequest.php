...
/**
 * Class FlashEditRequest
 * @package Notadd\Flash\Requests
 */
class FlashEditRequest extends FormRequest {
    /**
     * @return bool
     */
    ...
    public function rules() {
        return [
            'title' => 'required|unique:flashes,title,' . $this->route('flash') . '|alpha_dash|max:300',
            'alias' => 'required|unique:flashes,alias,' . $this->route('flash') . '|alpha_dash|max:300',
        ];
    }
}