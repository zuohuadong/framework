                ...
                <div class="col-md-12">
                    <div class="panel panel-lined clearfix mb30">
                        ...
                        <form class="form-horizontal col-md-12" action="{{ url('admin/flash/item/' . $item->id) }}" autocomplete="off" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-md-4 col-md-offset-4">以<strong>http://</strong>或<strong>https://</strong>开通的链接解析为外站链接</div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4"><strong>_blank：</strong>新窗口，<strong>_self：</strong>本窗口，<strong>_parent：</strong>父窗口，<strong>_top：</strong>顶层窗口。</div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">完成大图</label>
                                <div class="col-md-4">
                                <span class="btn btn-success btn-file">
                                    <i class="fa fa-image"></i>
                                    <span>上传图片</span>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">幻灯片说明</label>
                                <div class="col-md-4">
