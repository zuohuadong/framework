                                ...
                                <div class="col-md-6">
                                    <div class="btn-group" data-toggle="buttons">
                                        @if($item->target == '_blank')
                                            <label class="btn btn-primary btn-sm active"><input name="target" type="radio" value="_blank" checked>_blank</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_self">_self</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_parent">_parent</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_top">_top</label>
                                        @elseif($item->target == '_self')
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_blank" checked>_blank</label>
                                            <label class="btn btn-primary btn-sm active"><input name="target" type="radio" value="_self">_self</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_parent">_parent</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_top">_top</label>
                                        @elseif($item->target == '_parent')
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_blank" checked>_blank</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_self">_self</label>
                                            <label class="btn btn-primary btn-sm active"><input name="target" type="radio" value="_parent">_parent</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_top">_top</label>
                                        @elseif($item->target == '_top')
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_blank" checked>_blank</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_self">_self</label>
                                            <label class="btn btn-primary btn-sm"><input name="target" type="radio" value="_parent">_parent</label>
                                            <label class="btn btn-primary btn-sm active"><input name="target" type="radio" value="_top">_top</label>
                                        @endif
                                    </div>
                                </div>
                            </div>
