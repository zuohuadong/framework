            ...
            <div class="container">
                <div class="error-panel">
                    <ul class="install-info">
                        <li><label for="address">后台管理地址：</label><a href="#"><span id="address">http://www.aaa.com/admin</span></a></li>
                        <li><label for="index">前台首页：</label><a href="#"><span id="index">http://www.aaa.com</span></a></li>
                        <li class="finish"><label for="account">账号：</label><span id="account">admin@email.com</span></li>
